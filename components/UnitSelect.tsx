          ...
          {node.units.map((u) => (
            ...
            >
              <span className="flex items-center gap-2">
                <span className="flex h-[26px] w-[26px] flex-shrink-0 items-center justify-center rounded-[3px] border border-border bg-bg2 text-[13px]">
                  {u.icon}
                </span>
                <span className="font-head text-[13px] font-semibold tracking-[0.03em] text-text">
                  {u.name}
                </span>
              </span>
              <span className="pl-[34px] text-[9px] leading-[1.3] text-text3">{u.sub}</span>
            </button>
          ))}
        </div>
      </div>
