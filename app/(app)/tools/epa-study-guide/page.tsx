...
export const metadata = { title: 'EPA 608 Study Guide · TRACE' };
    ...
    <div>
      ...
      <Card className="mb-5 p-4">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          {EPA_SECTIONS.map((s) => (
            <div key={s.id} className="rounded-lg border border-border2 bg-bg3 px-3 py-2.5">
              ...
              <p className="mt-1 text-[12px] leading-relaxed text-text3">{s.blurb}</p>
            </div>
          ))}
        </div>
      </Card>
      ...
      <p className="mt-5 px-1 text-[12px] leading-relaxed text-text3">
